...
<div class="max-w-2xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Add Topic</h1>
            <p class="text-gray-600 dark:text-gray-400">Create a new topic/chapter for a subject</p>
        </div>
